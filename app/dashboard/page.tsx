        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-gray-600">Bem-vindo ao EliteADM</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Uso de IA</dt>
                      <dd className="text-lg font-medium text-gray-900">{user?.aiUsageCount || 0}/{user?.aiUsageLimit || 100}</dd>
                    </dl>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white shadow rounded-lg p-6 mb-8">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Bem-vindo ao EliteADM!</h2>
            <p className="text-gray-600 mb-4">
              Este é um sistema de demonstração para testes do cliente. Todas as funcionalidades estão disponíveis sem necessidade de login.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-900">Ver Projetos</p>
                </div>
              </button>
              ...
              <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-900">Usar IA</p>
                </div>
              </button>
